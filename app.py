...
# Process spectral bands if data exists
band_cols = []
x_axis_labels = []
    ...
    if selected_scenario == 'GAP_ANALYSIS':
        ...
        if not spectral_df.empty and selected_scenario != 'CHM_PROFILE':
            ...
            if selected_canopy_id:
                ...
                # DEFAULT VIEW: Plot Average of Targets vs Baseline
                st.subheader("Group Spectral Signature")
                st.caption("Click a canopy on the map to view its specific signature.")
